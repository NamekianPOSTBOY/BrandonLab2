...
public class rodriguesActivityDetached extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CheckBox box1 = (CheckBox) findViewById(R.id.brandon_CheckBoxD1);
        final CheckBox box2 = (CheckBox) findViewById(R.id.brandon_CheckBoxD2);
        final CheckBox box3 = (CheckBox) findViewById(R.id.brandon_CheckBoxD3);
        final CheckBox box4 = (CheckBox) findViewById(R.id.brandon_CheckBoxD4);
        ...
        checkoutBttn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(box1.isChecked()){
                    prefEditor.putString("mySelectedHomes1", getResources().getString(R.string.detached1));
                    count++;
                    prefEditor.apply();
                }
                if(box2.isChecked()){
                    prefEditor.putString("mySelectedHomes2", getResources().getString(R.string.detached2));
                    prefEditor.apply();
                    count++;
                }
                if(box3.isChecked()){
                    prefEditor.putString("mySelectedHomes3", getResources().getString(R.string.detached3));
                    count++;
                    prefEditor.apply();
                }
                if(box4.isChecked()){
                    prefEditor.putString("mySelectedHomes4", getResources().getString(R.string.detached4));
                    prefEditor.apply();
                    count++;
                }
